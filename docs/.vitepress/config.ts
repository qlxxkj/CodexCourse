      ...
      '/': [
        {
          ...
          items: [
            { text: '课程简介', link: '/' },
            { text: '课前准备清单', link: '/appendix/prep-checklist' },
            { text: '术语速查表', link: '/appendix/glossary' },
            { text: '常见问题 FAQ', link: '/appendix/faq' },
            { text: '课后反馈表', link: '/appendix/feedback' },
          ],
        },
        {
          text: '模块一：认识 Codex',
          collapsed: false,
          items: [
            { text: '第 1 课：AI 编程助手是什么？', link: '/modules/module-1/lesson-1' },
            { text: '第 2 课：Codex 能帮你做什么？', link: '/modules/module-1/lesson-2' },
            { text: '第 3 课：Codex vs 其他工具', link: '/modules/module-1/lesson-3' },
          ],
        },
        {
          text: '模块二：上手准备',
          collapsed: false,
          items: [
            { text: '第 4 课：准备工作', link: '/modules/module-2/lesson-4' },
            { text: '第 5 课：安装 Codex 桌面 App', link: '/modules/module-2/lesson-5' },
            { text: '第 6 课：认识 Codex 界面', link: '/modules/module-2/lesson-6' },
            { text: '第 7 课：第一次对话', link: '/modules/module-2/lesson-7' },
          ],
        },
        {
          text: '模块三：核心功能',
          collapsed: false,
          items: [
            { text: '第 8 课：文件操作', link: '/modules/module-3/lesson-8' },
            { text: '第 9 课：自然语言驱动', link: '/modules/module-3/lesson-9' },
            { text: '第 10 课：联网与资料检索', link: '/modules/module-3/lesson-10' },
            { text: '第 11 课：自动化任务', link: '/modules/module-3/lesson-11' },
          ],
        },
        {
          text: '模块四：实用技巧',
          collapsed: false,
          items: [
            { text: '第 12 课：如何写出更好的指令', link: '/modules/module-4/lesson-12' },
            { text: '第 13 课：安全与权限管理', link: '/modules/module-4/lesson-13' },
            { text: '第 14 课：Codex 的"技能"', link: '/modules/module-4/lesson-14' },
          ],
        },
        {
          text: '模块五：项目实战',
          collapsed: false,
          items: [
            { text: '项目一：整理你的电脑', link: '/modules/module-5/project-1' },
            { text: '项目二：生成一份 PPT 报告', link: '/modules/module-5/project-2' },
            { text: '项目三：做一个简单网页', link: '/modules/module-5/project-3' },
            { text: '项目四：待办事项管理小工具', link: '/modules/module-5/project-4' },
          ],
        },
        {
          text: '模块六：总结与进阶',
          collapsed: false,
          items: [
            { text: '第 15 课：课程回顾与学习路径', link: '/modules/module-6/lesson-15' },
            { text: '第 16 课：下一步可以学什么', link: '/modules/module-6/lesson-16' },
          ],
        },
      ],
      '/en/': [
